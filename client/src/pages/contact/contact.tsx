  ...
  return (
    <div className='container logo'>
      ...
      <div className='row'>
        ...
        <div className='row mt-5 shadow-like2'>
          <div className='col-md-8'>
            <h1>About Us</h1>
            <p>
              Car Service is a company specializing in the repair of all types
              of vehicles, including luxury vehicles. Our team is made up of
              people who have gone through internships in authorized garages of
              various companies, so with us you can find an effective, fast, and
              fair solution for any vehicle!
            </p>
            <p>
              At Car Service, the customer is our top priority. That's why we
              offer 24/7 customer service, a six-month warranty on repairs, and
        ...
        <div className='row mt-5 '>
          <div className='col-md-6 float-left shadow-like2 '>
          ...
          <div className='col-md-6 float-right shadow-like2'>
